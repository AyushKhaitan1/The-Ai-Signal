    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#FFF5F6] via-[#FFF8F9] to-[#FFF0F2] border border-airbnb-border-light rounded-[24px] p-4 md:py-4 md:px-6 shadow-[0_4px_30px_rgba(0,0,0,0.012)] flex flex-col lg:flex-row justify-between items-center gap-4">
        ...
        <div className="hidden lg:flex items-center justify-center w-[45%] min-w-[340px] max-w-[440px] relative h-[130px] select-none self-center">
          ...
          <div className="absolute top-[0px] right-[10px] bg-white rounded-xl p-1.5 px-2 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border border-airbnb-border-light/60 flex items-center space-x-2 w-[150px] transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)]">
          ...
          {/* Floating Card 2: Anthropic launches Claude 3.5 (Middle Left - Indented to avoid search bar) */}
          <div className="absolute top-[45px] left-[40px] bg-white rounded-xl p-1.5 px-2 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border border-airbnb-border-light/60 flex items-center space-x-2 w-[150px] transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)]">
          ...
          <div className="absolute bottom-[0px] right-[10px] bg-white rounded-xl p-1.5 px-2 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border border-airbnb-border-light/60 flex items-center space-x-2 w-[150px] transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)]">
