      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="col-span-1 lg:col-span-2 space-y-4">
          <div className="bg-white border border-airbnb-border-light rounded-2xl p-6 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
            <h1 className="text-xl font-bold tracking-tight text-airbnb-charcoal">Developer Tools & Agentic Systems</h1>
            <p className="text-xs text-airbnb-gray mt-1">
              Tracking software development IDEs, developer platforms, and agentic workflows.
            </p>
          </div>
